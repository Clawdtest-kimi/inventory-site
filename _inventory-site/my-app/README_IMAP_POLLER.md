...
```bash
node -e "require('imap-simple').connect({imap:{user:'stock@packaging.team',password:'***REMOVED***',host:'mail.privateemail.com',port:993,tls:true}}).then(c=>{console.log('✅ Connected');c.end()})"
```
