      ...
      <div className="mt-12 bg-white rounded-lg shadow-sm border border-slate-200 p-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <a
            ...
            className="flex items-center gap-2 px-4 py-3 bg-slate-800 text-white rounded-lg hover:bg-slate-700 transition-colors text-sm font-medium"
          >
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition-colors text-sm font-medium"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
